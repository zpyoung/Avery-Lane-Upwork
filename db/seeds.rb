...
User.create!({ :first_name=> "Zach", :last_name=> "Young", :email=> "zach@fabledfreedom.com", :password=>"admin1234",  :password_confirmation=> "admin1234", :role=> User::Role::ADMIN, :support=> true})
